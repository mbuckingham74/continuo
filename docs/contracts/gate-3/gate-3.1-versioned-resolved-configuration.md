...
[`Gate 4.1`](../gate-4/gate-4.1-effort-provider-account-amendment.md) advances
the first implemented configuration shape to schema 2 and replaces route-only
selection with complete route/provider-account bindings.
