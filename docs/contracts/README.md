...
- [`gate-4/`](gate-4/) contains bounded Generic Engine Core implementation
  ...
  - [`gate-4.3-provider-adapter-extraction.md`](gate-4/gate-4.3-provider-adapter-extraction.md) is the contract awaiting repository-owner approval before Gate 4.3 implementation begins.
